    ...
    >
      ...
      <ContentContainer>
        <div className={classNames(classes.terms_and_conditions_wrapper)}>
          <span className="terms" style={{ marginBottom: "10px" }}>
            Privacy Policy
          </span>
          <p style={{ marginTop: "10px" }}>Last updated: February 14, 2024</p>
          <p>
          ...
          <span className="terms">Collecting and Using Your Personal Data</span>
          <br />
          <span
            className={classNames(classes.terms_and_conditions_subheadings)}
          >
            Personal Data
          </span>
          <p>
          ...
          <span className="terms">Use of Your Personal Data</span>
          ...
          <span className="terms">Retention of Your Personal Data</span>
          <p>
          ...
          <span className="terms">Transfer of Your Personal Data</span>
          <p>
          ...
          <span className="terms">Delete Your Personal Data</span>
          <p>
          ...
          <span className="terms">Disclosure of Your Personal Data</span>
          <br />
          <span
            className={classNames(classes.terms_and_conditions_subheadings)}
          >
          ...
          <span className="terms">Security of Your Personal Data</span>
          <p>
          ...
          <span className="terms">Links to Other Websites</span>
          <p>
