...
var GhostButton = function GhostButton(props) {
  ...
  }, children != null ? children : React__default.createElement("ul", null, React__default.createElement("li", null, "ABOUT"), React__default.createElement("li", null, "PROJECTS"), React__default.createElement("li", null, "ELEMENTS"), React__default.createElement("li", null, "CONTACT")))));
};
...
var GhostNavbar = function GhostNavbar(props) {
  ...
  }, "\xA0"), React__default.createElement("nav", {
    className: classId + "-navigation__nav " + classId + "-navigation__nav--" + revealType
  }, children ? children : React__default.createElement("ul", null, React__default.createElement("li", null, "ABOUT"), React__default.createElement("li", null, "PROJECTS"), React__default.createElement("li", null, "ELEMENTS"), React__default.createElement("li", null, "CONTACT"))));
};
...
var ResponsiveNavbar = function ResponsiveNavbar(props) {
  ...
  return React__default.createElement("div", {
    className: classId + "-navigation " + className,
    style: _extends({}, styles == null ? void 0 : styles.navigation, cssVariables)
  }, !media && React__default.createElement(React__default.Fragment, null, React__default.createElement("input", {
    type: "checkbox",
    className: classId + "-navigation__checkbox",
    id: classId + "-navigation-toggle-" + uniqueId,
  ...
  }, logo && React__default.createElement("span", null, logo), React__default.createElement("span", {
    className: classId + "-navigation__icon",
    "data-testid": 'GhostNavbar-icon',
  ...
  }, media && logo && React__default.createElement("ul", {
    className: classId + "-navigation__logo"
  }, React__default.createElement("li", null, logo)), children != null ? children : React__default.createElement("ul", null, React__default.createElement("li", null, "ABOUT"), React__default.createElement("li", null, "PROJECTS"), React__default.createElement("li", null, "ELEMENTS"), React__default.createElement("li", null, "CONTACT"))));
};

exports.GhostButton = GhostButton;
exports.GhostNavbar = GhostNavbar;
exports.ResponsiveNavbar = ResponsiveNavbar;
//# sourceMappingURL=react-hamburger-menus.cjs.development.js.map
